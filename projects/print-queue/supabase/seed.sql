...
-- ── Filaments ─────────────────────────────────────────────────────────────────
INSERT INTO filaments (id, brand, material, color, color_hex, in_stock, roll_cost, roll_size_g, current_quantity_g, purchase_url)
VALUES
  ('a1000001-0000-0000-0000-000000000001', 'Generic', 'PLA', 'Black',      '#1a1a1a', true, 20, 1000, 1000, ''),
  ('a1000001-0000-0000-0000-000000000002', 'Generic', 'PLA', 'Dark Blue',  '#1e40af', true, 20, 1000, 1000, ''),
  ('a1000001-0000-0000-0000-000000000003', 'Generic', 'PLA', 'Green',      '#22c55e', true, 20, 1000, 1000, ''),
  ('a1000001-0000-0000-0000-000000000004', 'Generic', 'PLA', 'Light Blue', '#7dd3fc', true, 20, 1000, 1000, ''),
  ('a1000001-0000-0000-0000-000000000005', 'Generic', 'PLA', 'Pink',       '#f472b6', true, 20, 1000, 1000, ''),
  ('a1000001-0000-0000-0000-000000000006', 'Generic', 'PLA', 'Purple',     '#a855f7', true, 20, 1000, 1000, ''),
  ('a1000001-0000-0000-0000-000000000007', 'Generic', 'PLA', 'Red',        '#ef4444', true, 20, 1000, 1000, ''),
  ('a1000001-0000-0000-0000-000000000008', 'Generic', 'PLA', 'White',      '#f5f5f5', true, 20, 1000, 1000, ''),
  ('a1000001-0000-0000-0000-000000000009', 'Generic', 'PLA', 'Yellow',     '#fde047', true, 20, 1000, 1000, '')
