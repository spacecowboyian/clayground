import{j as r}from"./jsx-runtime-CFY_2KVU.js";import{$ as w}from"./Checkbox-Dy6uToZ0.js";import{c as n}from"./cn-DjqsqOe8.js";import{C as R}from"./check-Be_n60n5.js";import"./index-Dq4ZvVuH.js";import"./_commonjsHelpers-CqkleIqs.js";import"./RSPContexts-jO5RJh7k.js";import"./utils-DjPIWxND.js";import"./Form-gc0L3y2f.js";import"./useFocusRing-bcsqZzxB.js";import"./usePress-COXelEbW.js";import"./textSelection-Bkgdry2w.js";import"./index-BodQkoVg.js";import"./index-N4qaH3Gp.js";import"./useToggle-B2ujAqER.js";import"./useFormReset-nDzEqCj4.js";import"./useToggleState-bM5DcLtG.js";import"./useControlledState-BJxFPo-I.js";import"./VisuallyHidden-CdOe57Pj.js";import"./createLucideIcon-BnGyhE3A.js";const T={orange:"group-data-[selected]:bg-[var(--accent-orange)] group-data-[selected]:border-[var(--accent-orange)]",blue:"group-data-[selected]:bg-[var(--accent-blue)] group-data-[selected]:border-[var(--accent-blue)]",green:"group-data-[selected]:bg-[var(--accent-green)] group-data-[selected]:border-[var(--accent-green)]",purple:"group-data-[selected]:bg-[var(--accent-purple)] group-data-[selected]:border-[var(--accent-purple)]"};function l({children:e,color:N="blue",className:y,...j}){return r.jsxs(w,{className:n("flex items-center gap-2 group cursor-default",y),...j,children:[r.jsx("div",{className:n("w-5 h-5 rounded border-2 border-border bg-input flex items-center justify-center transition-colors",T[N]),children:r.jsx(R,{className:"w-3 h-3 text-white opacity-0 group-data-[selected]:opacity-100 transition-opacity"})}),e&&r.jsx("span",{className:"text-sm text-foreground",children:e})]})}l.__docgenInfo={description:"",methods:[],displayName:"Checkbox",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},color:{required:!1,tsType:{name:"union",raw:"'orange' | 'blue' | 'green' | 'purple'",elements:[{name:"literal",value:"'orange'"},{name:"literal",value:"'blue'"},{name:"literal",value:"'green'"},{name:"literal",value:"'purple'"}]},description:"",defaultValue:{value:"'blue'",computed:!1}},className:{required:!1,tsType:{name:"string"},description:""}},composes:["CheckboxProps"]};const W={title:"Components/Checkbox",component:l,tags:["autodocs"],argTypes:{color:{control:"select",options:["orange","blue","green","purple"]},isSelected:{control:"boolean"},defaultSelected:{control:"boolean"},isDisabled:{control:"boolean"},children:{control:"text"}}},a={args:{color:"blue",children:"Accept terms and conditions"}},o={args:{color:"green",defaultSelected:!0,children:"Subscribe to newsletter"}},t={args:{color:"blue",isDisabled:!0,children:"Disabled option"}},c={args:{color:"blue",isDisabled:!0,defaultSelected:!0,children:"Disabled & checked"}},s={render:()=>r.jsx("div",{className:"flex flex-col gap-3",children:["orange","blue","green","purple"].map(e=>r.jsx(l,{color:e,defaultSelected:!0,className:"capitalize",children:e},e))})};var d,i,p;a.parameters={...a.parameters,docs:{...(d=a.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
    color: 'blue',
